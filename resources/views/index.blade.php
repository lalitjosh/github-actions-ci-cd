...
@section('content')
		...
		<div class="hero-slider">
			<div class="hero-slide-item set-bg" data-setbg="{{asset('img/bg.jpg')}}">
				<div class="slide-inner">
					...
					<h2>Standard <br>Architecture <br> and more</h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 intro-text mb-5 mb-lg-0">
					...
					<p>We Build Your Dream into Reality. Design is a place where science and art break even. Exploring the Quality Way through Design". </p>
					...
					<div class="service-box">
						<div class="sb-icon">
							<div class="sb-img-icon">
								<img src="{{asset('img/icon/dark/1.png')}}" alt="">
							</div>
						</div>
						<h3>Plans and Projects</h3>
						<p>Our meticulously crafted architectural plans and projects seamlessly blend functionality and aesthetics, creating spaces that inspire and elevate the human experience.</p>
	...
	<div class="projects-section pb50">
		...
		<div id="projects-carousel" class="projects-slider">
			<div class="single-project set-bg rest" data-setbg="{{('img/projects/1.jp')}}g">
			...
			<div class="single-project set-bg build" data-setbg="{{('img/projects/2.jp')}}g">
				<div class="project-content">
					<h2>House <br> Building</h2>
					<p>Jan 19, 2018</p>
					<a href="#" class="seemore">See Project </a>
				</div>
			</div>
			<div class="single-project set-bg apart" data-setbg="{{('img/projects/3.jp')}}g">
				<div class="project-content">
			...
			<div class="single-project set-bg rest" data-setbg="{{('img/projects/4.jp')}}g">
				<div class="project-content">
					<h2>Biggest <br> Restaurations</h2>
					<p>Jan 19, 2018</p>
					<a href="#" class="seemore">See Project </a>
			...
			<div class="single-project set-bg apart" data-setbg="{{('img/projects/2.jp')}}g">
				<div class="project-content">
